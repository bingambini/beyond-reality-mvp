...
with st.sidebar:
    ...
    if st.button("▶️ გაუშვი მთლიანი ნაკადი"):
        ...
        st.session_state.pipeline_logs = [] # ვასუფთავებთ ძველ ლოგებს ახალი გაშვებისთვის
        st.rerun()
...
# ==================== 6. 📂 OUTPUT ფაილების ბრაუზერი & ჩამოტვირთვა ====================
st.divider()
with st.expander("📂 დაგენერირებული ფაილების ნახვა & ჩამოტვირთვა", expanded=True):
    output_dir = "./output"
...
st.caption("💡 Streamlit Cloud-ზე ფაილები ინახება მხოლოდ აქტიური სესიის დროს. ჩამოტვირთე ადგილობრივ მოწყობილობაში სამუდამოდ შესანახად.")
